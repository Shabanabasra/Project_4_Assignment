...
#Asks the user for their last name and stores it in a variable Asks the user for their email address and stores it in a variable Returns all three of these pieces of data in the order it was asked
#You can return multiple pieces of data by separating each piece with a comma in the return line.Here is an example run of the program:
# What is your first name?: Jane .What is your last name?: Stanford
...
def main():
    """Gets user data and prints it in a structured format."""
